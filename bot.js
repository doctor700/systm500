...
❧ +user ⇏ معلومات عن شخص الي تبيه بلمنشن 
   ...
   ❧ + steam  ⇏للبحث عن اي لعبه في ستيم
**
   
         **اوامر مميزة**
   **
   +اسال اي سوال والبوت بيجاوب بي نعم او لا [+هل انا جميل] /هل  
...
**
   ❧ +bc ⇏ برود كست بي امبيد وبدون امبيد
   ❧ +AutoRole ⇏  لمعرفه الميزه شغاله [+info] اعطاء رتبه تلقائيا 
   ❧ +unbanall ⇏  يقوم بفك البان عن جميع الاعضاء في السيرفر  
   ❧ +nickall ⇏ الشعار | Username يضع شعار لكل الاعضاء
   ❧ +setlog ⇏ [log]يقوم بعمل روم  لتعرف كل شي عن الاعضاء من يث المغادره او الميوت الخ او اعمل روم 
   ❧ +setwelcomer ⇏  <welcome> يجب ان يكون اسم روم الترحيب 
   ❧ +c.t ⇏ يقوم بصنع روم كتابي عن طريق كتب اسمه  مقال [+c.t name room 
   ❧ +c.v ⇏ يقوم بصنع روم صوتي عن طريق كتب اسمه  مقال [+c.v name room 
   ❧ +c.d ⇏ يقوم بمسح روم صوتي عن طريق كتب اسمه  مقال [+c.d name room 
   ❧ +clear <number> ⇏ البوت يمسح الرسال برقم حد اقصي 100 رساله
   ❧ +kick @user <reason> ⇏ طرد الشخص من السيرفر
   ❧ +ban @user <reason> ⇏ حضر الشخص من السيرفر
   ❧ +setstats ⇏ يعمل روم لك بلوقت والتاريخ والاشخاص المتصلين في الرومات
   ❧ +banlist ⇏ عدد الاشخاص المبندة 
   **
       
         **اوامر ادارية عالية**
   **
   ❧ +say ⇏البوت يكرر الكلام الي قلته ب امبد
   ❧ +role ⇏ لعطاء رتب للعضاء ويمكن التفرقه بين البوتات وللاشخاص 
   ❧ +clear ⇏لمسح الشات بعدد او بدون
   ❧ +unban ⇏ لفك البان لشخص عن طريق الايدي تبعه 
   ❧ +mute ⇏  يعطي ميوت كتابي للشخص 
   ❧ +vkick ⇏ لطرد عضو من الروم الصوتي 
   ❧ +vban ⇏ لحظر عضو من روم صوتي 
   ❧ +vunban ⇏ لفك حظر عضو من الروم الصوتي 
   ❧ +unmute ⇏  يفك ميوت كتابي للشخص 
   ❧ +mutevoice ⇏ يفك ميوت صوتي للشخص 
   ❧ +unmutevoice ⇏ يفك ميوت صوتي للشخص 
...
❧ +slots ⇏ ['🍏''🍇' '🍒' '🍍' '🍅' '🍆' '🍑' '🍓'] جمع 3 من نفس الشي تفوز
   ...
   **اوامرالالوان**
   ** 
   ❧ +addcolors ⇏ يصنع لك رتب ملونه جاهزه بعدد الي تحدده 
   ❧ +decolors ⇏  لمسح الرتب الملونه فقط 
   ❧ +color ⇏ لختيار لونك 
    قريبا ⇏ لرويه قائمه الالوان 
...
reaction3.on("collect", r => {
  const embed = new Discord.RichEmbed()
      ...
      .setDescription(`**
            -=-  اوامر الحمايه -=-
『=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.』
+limitsban لتحديد عدد الباندات يلي بعدها يزيل رتبه من يحاول التهكير
+limitskick لتحديد عدد الكيك بعدها يزيل رتبه من يحاول التهكير
+limitsroleD تحديد عدد الرتب الممسوحة التي من بعدها يتم تنزيل رتبة من يحاول التهكير
